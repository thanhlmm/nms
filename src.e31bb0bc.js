...
var CONTRACT_NAME = "dev-1626400442960-15347105963967" || 'dev-1626400442960-15347105963967';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, toAccount = _event$target$element.toAccount, title = _event$target$element.title, content = _event$target$element.content; // disable the save button, since it now matches the persisted value
...
function checkSubmitButton() {
  ...
  var value3 = document.querySelector('input#content').value;
...
function showHideNewMsg() {
  var obj = document.querySelector('#btnShowHideNewMsg');
  var msgBoard = document.querySelector('#newMsgBoard');
...
function _fetchMessages() {
  _fetchMessages = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var viewMsgNum, sentMsgNum, sentMessages, inboxMsgNum, inboxMessages;
